...
class CatCast extends StatefulWidget {
  @override
  _CatCastState createState() => new _CatCastState();
}

class _CatCastState extends State<CatCast> {
  String _cityEntered;
        ...
        children: <Widget>[
          ...
          new Container(
            ...
            child: new Text(
              //"Test",
              //_cityEntered,
              '${ _cityEntered != null ? _cityEntered : util.defaultCity }',
              style: cityStyle(),
            ),
          ),
